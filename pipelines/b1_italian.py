...
# you can switch this to mixtral, maverick, or any other model later and also fix the path
MODEL_NAME = 'mistralai/mixtral-8x22b-instruct'
LANGUAGE = 'it'
INPUT_CSV = 'it_pilot_test.csv'
OUTPUT_CSV = 'it_B1_results.csv'
REQUEST_TIMEOUT = 120
ROW_SLEEP_SECONDS = 1
...
: slightly
: ['la nostra schiavitù elettronica']
: ['Se il titolo è posto in questi termini, allora potrebbe essere sensazionalistico e manipolare emotivamente i lettori']
...
: moderately
: ['i vernacoli sempre più gutturali e belluini', 'nella decrescita felice andranno alla raccolta dei mitili e bacche e impareranno ad abitare sulle palafitte (abusive, naturalmente), come i cacciatori-raccoglitori della civiltà villanoviana']
: ['attribuire alle lingue locali gli aggettivi "gutturali" e "belluini" è offensivo', 'si tratta di un assunto per cui i popoli africani siano da considerare selvaggi e arretrati']
...
Se non era presente alcuno span, restituisci esattamente : ["No"]. Riprova:
...
def main():
    ...
    print(f'starting italian b1 run with model: {MODEL_NAME}')
